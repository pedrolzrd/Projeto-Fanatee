...
public class SlowTerrainSpawner : MonoBehaviour
{
    //Variaveis
    [SerializeField]
    float nextSpawn;
    ...
    //Objetos/Componentes
    [SerializeField]
    GameObject slowTerrainParticleSystem;
    [SerializeField]
    ...
    IEnumerator Spawn()
    {
        ...
        Instantiate(slowTerrainParticleSystem, spawnPos, Quaternion.Euler(-90, 180, 0));
        spawned++;
